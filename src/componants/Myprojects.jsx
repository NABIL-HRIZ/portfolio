...
const MyProjects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Application de gestion de projets développée en Laravel et React, intégrant rôles, notifications temps réel et API documentée.",
      tags: ["Laravel", "React","SweetAlert","ReChartJs" , "Pusher" , "MailTrap" , "Swagger"],
      image:secure, 
      demoLink: "#",
    ...
    },
    {
      ...
      description: "Développeur Front-End React – Création d’une application web dynamique avec Redux, API externe et interface responsive performante.",
      tags: ["React","Redux","Tailwind","React Bits", "Gsap" ,"ThreeJs" , "AtroposJs" ,  "Rest Api",],
      image:food, 
      demoLink: "#",
    ...
    },
    {
      id: 4,
      name: "MOVIESCOPE",
      description: "Application web moderne pour découvrir et explorer films et séries selon vos préférences, avec une interface épurée et interactive.",
      tags: ["React","SwiperJs","AOS (Animate On Scroll)", "Rest Api"],
      image:movie, 
      demoLink: "#",
