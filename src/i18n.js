...
const resources = {
  en: {
    translation: {
      ...
      ,
      list: [
        {id:1, name: 'PAWSADOPT ', description: 'Design and development of a Full-Stack SaaS platform dedicated to optimizing the animal adoption process, featuring interactive mapping, a multi-user management system, and secure subscription-based monetization. End-to-end application development including high-performance REST APIs, advanced security, and a responsive interface with third-party service integrations.', tags: ['Spring Boot 3','Java','React','Tailwind CSS','MySQL','Leaflet.js','Stripe API','Spring Security','Axios','Docker']},
        ...
        { id: 7, name: 'SECUREBOARD ', description: 'Full-Stack app (Laravel + React) for project management with auth, roles & permissions, real-time notifications (Pusher), async emails and API documentation (Swagger).', tags: ['Laravel','React','Pusher','Echo','MailTrap'] },

        { id: 8, name: 'MOVIESCOPE', description: 'Modern web app to discover and explore movies and series with a clean UI, interactive features and an immersive intro video.', tags: ['React','Swiper','AOS','REST API'] },
        { id: 9, name: 'HITRADIO_WEATHER', description: 'Weather features integrated for HitRadio to enrich listeners experience on the official site with modern UX and dynamic data.', tags: ['React','GSAP','REST API'] },
        { id: 10, name: 'Sky 365', description: 'Modern responsive hotel booking website.', tags: ['Figma','React','Uiverse','Material UI'] },
        { id: 11, name: 'Educaty', description: 'Innovative learning platform transforming how students access online educational resources.', tags: ['Figma','React','Bootstrap'] },
        { id: 12, name: 'SERVICE_JARDINAGE', description: 'Professional gardening services website with online quote requests.', tags: ['React','Bootstrap','EmailJS','Swiper'] },
        { id: 13, name: 'HONEY WEB', description: 'Selection of artisanal honeys from local sustainable sources with product descriptions and categories.', tags: ['React','Bootstrap','EmailJS'] },
        { id: 14, name: 'DARIShop', description: 'Ecommerce platform for home products — curated selections to beautify and optimize living spaces.', tags: ['Laravel','Blade','MySQL','HTML','CSS','JS','Tailwind'] },
        { id: 15, name: 'Pizza Dyalna', description: 'Delicious pizza website delivering flavorful experiences and easy online ordering.', tags: ['Laravel','Blade','MySQL','HTML','CSS','JS','Tailwind'] }
      ]
      },
      tools: {
  ...
  fr: {
    translation: {
      ...
      ,
      list: [
        { id: 1, name: 'PAWSADOPT ', description :"Conception d’une plateforme SaaS Full-Stack dédiée à l’optimisation du processus d’adoption d’animaux, intégrant une cartographie interactive, un système de gestion multi-utilisateurs et une monétisation sécurisée via abonnement. Développement complet du cycle applicatif : API REST performantes, sécurité avancée et interface réactive avec intégration de services tiers." , tags: ['Spring Boot 3', 'Java', 'React', 'Tailwind CSS', 'MySQL', 'Leaflet.js', 'Stripe API', 'Spring Security', 'Axios', 'Docker']},
